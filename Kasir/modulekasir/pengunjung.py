...
def read_data_pengunjung():
    path = getpaths()
    read_data = pd.read_csv(f"{path}\\daftar_pengunjung.csv")
    ...
    DataPengunjung = namedtuple("ListDataPengunjung",["list_data","no_order","nama_menu","harga","jumlah","total","tanggal","no_order_duplicate"])
    
    return DataPengunjung (list_data,no_order,nama_menu,harga,jumlah,total,tanggal,no_order_duplicate)
